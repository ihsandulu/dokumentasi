        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="<?= base_url(); ?>">
                ...
                <b>                    
                    ...
                    if($storepicture!=""){$user_image="images/store_picture/".$storepicture;}else{$user_image="images/store_picture/logo.png";}?>
                    <img width="30" height="30" src="<?=base_url($user_image);?>" alt="" class="dark-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
